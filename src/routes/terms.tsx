...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms & Conditions — Stocks City" },
      { name: "description", content: "Terms and conditions for using the Stocks City learning platform." },
  ...
  component: () => (
    <SiteLayout>
      ...
      <section className="mx-auto max-w-3xl space-y-4 px-4 py-12 text-gray-300">
        <p>Stocks City provides stock market education for informational purposes only. Nothing on this site is financial advice, a recommendation, or a solicitation to buy or sell securities.</p>
